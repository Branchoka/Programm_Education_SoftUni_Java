...
public class E05_Matrix_Shuffling {
    ...
    private static void getFillMatrix(String[][] matrix, Scanner scanner) {
    ...
    private static boolean validateCommand(String command,int rows,int cols) {
        ...
        if (!commandParts[0].startsWith("swap")){
            return false;
        }
