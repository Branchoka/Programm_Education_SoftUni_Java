...
public class E09_Parking_System {
    public static void main(String[] args) {
        ...
        while (!token.equalsIgnoreCase("stop")){
            ...
            if (!isSpotTaken(matrix,rowIndexForPark,colIndexForPark)){
                ...
                if ((rightDistance < leftDistance && rightDistance != -1) || (leftDistance == -1 && rightDistance != -1)){
                    matrix[rowIndexForPark][rightIndex] = true;
                    distance += rightIndex + 1;
                    isSpotFree = true;
                }else if ((leftDistance <= rightDistance && leftDistance != -1) || (rightDistance == -1 && leftDistance != -1)){
